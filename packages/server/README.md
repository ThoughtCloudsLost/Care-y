...
Node.js + tRPC API server for CARE-Y - auth, webhooks, and telephony relay endpoints.
...
| Telephony       | Twilio (provider interface)  | Inbound webhooks, outbound relay - Twilio → Fonoster swap planned |
