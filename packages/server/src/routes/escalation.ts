 ...
 *
 * CRUD for time-based escalation rules (MANAGE_ESCALATION). Each rule is scoped
...
export function createEscalationRouter(deps: EscalationRouterDeps) {
  return router({
    ...
    list: manageEscalationProcedure.input(listEscalationRulesInputSchema).query(
    ...
    create: manageEscalationProcedure
      .input(createEscalationRuleInputSchema)
      .mutation(
        withErrorWrapping(async ({ ctx, input }) => {
    ...
    update: manageEscalationProcedure
      .input(updateEscalationRuleInputSchema)
      .mutation(
        withErrorWrapping(async ({ ctx, input }) => {
    ...
    remove: manageEscalationProcedure
      .input(deleteEscalationRuleInputSchema)
      .mutation(
        withErrorWrapping(async ({ ctx, input }) => {
