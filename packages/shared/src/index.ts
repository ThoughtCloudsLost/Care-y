...
export {
  ...
  RESEAL_TABLE_NAMES,
  type ResealTableName,
  resealRowsSchema,
  type ResealRowsInput,
  INDEX_TABLE_NAMES,
  type IndexTableName,
  reindexRowsSchema,
  type ReindexRowsInput,
  resealPendingSchema,
  type ResealPendingInput,
  ...
  RESEAL_BLOB_TABLE_NAMES,
  type ResealBlobTableName,
  resealBlobPendingSchema,
  type ResealBlobPendingInput,
  resealBlobRowSchema,
  type ResealBlobRowInput,
  listFormAssetsForResealSchema,
  type ListFormAssetsForResealInput,
  getFormAssetBlobSchema,
  type GetFormAssetBlobInput,
  replaceFormAssetBlobSchema,
  type ReplaceFormAssetBlobInput,
...
export {
  ...
  portalReplyAttachmentSchema,
  type PortalReplyAttachment,
...
export {
  ...
  portalAttachmentIdSchema,
  portalRecordingIdSchema,
  ...
  type PortalAttachmentId,
  type PortalRecordingId,
