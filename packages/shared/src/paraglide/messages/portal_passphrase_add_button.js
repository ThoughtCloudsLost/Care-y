...
*/
export const portal_passphrase_add_button = /** @type {((inputs?: Portal_Passphrase_Add_ButtonInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Portal_Passphrase_Add_ButtonInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_portal_passphrase_add_button(inputs)
	return es_portal_passphrase_add_button(inputs)
});