...
/** @typedef {{}} Hub_Queues_SubtitleInputs */

const en_hub_queues_subtitle = /** @type {(inputs: Hub_Queues_SubtitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Create and assign ticket queues`)
};

const es_hub_queues_subtitle = /** @type {(inputs: Hub_Queues_SubtitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Crear y asignar colas de tickets`)
};
