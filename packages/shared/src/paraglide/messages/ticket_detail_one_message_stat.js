...
*/
export const ticket_detail_one_message_stat = /** @type {((inputs?: Ticket_Detail_One_Message_StatInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Ticket_Detail_One_Message_StatInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_ticket_detail_one_message_stat(inputs)
	return es_ticket_detail_one_message_stat(inputs)
});