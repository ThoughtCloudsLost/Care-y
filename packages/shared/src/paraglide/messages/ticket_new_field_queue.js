...
/** @typedef {{}} Ticket_New_Field_QueueInputs */

const en_ticket_new_field_queue = /** @type {(inputs: Ticket_New_Field_QueueInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queue`)
};

const es_ticket_new_field_queue = /** @type {(inputs: Ticket_New_Field_QueueInputs) => LocalizedString} */ () => {
