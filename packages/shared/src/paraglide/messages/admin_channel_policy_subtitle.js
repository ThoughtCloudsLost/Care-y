...
const en_xa2_admin_channel_policy_subtitle = /** @type {(inputs: Admin_Channel_Policy_SubtitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Còntròl whìch còmmùnìcàtìòn chànnèls àrè àvàìlàblè tò vòlùntèèrs. ••••••••••••••••••••⟧`)
};
...
*/
export const admin_channel_policy_subtitle = /** @type {((inputs?: Admin_Channel_Policy_SubtitleInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Channel_Policy_SubtitleInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_admin_channel_policy_subtitle(inputs)
	if (locale === "en-XA") return en_xa2_admin_channel_policy_subtitle(inputs)
