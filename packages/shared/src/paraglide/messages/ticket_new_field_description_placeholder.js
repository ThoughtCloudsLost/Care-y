...
*/
export const ticket_new_field_description_placeholder = /** @type {((inputs?: Ticket_New_Field_Description_PlaceholderInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Ticket_New_Field_Description_PlaceholderInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_ticket_new_field_description_placeholder(inputs)
	return es_ticket_new_field_description_placeholder(inputs)
});