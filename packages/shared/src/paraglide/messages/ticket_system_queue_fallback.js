...
/** @typedef {{}} Ticket_System_Queue_FallbackInputs */

const en_ticket_system_queue_fallback = /** @type {(inputs: Ticket_System_Queue_FallbackInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`another queue`)
};

const es_ticket_system_queue_fallback = /** @type {(inputs: Ticket_System_Queue_FallbackInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`otra cola`)
};
