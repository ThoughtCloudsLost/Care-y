...
**Close prompts.** Note types can be marked as required on close. When a volunteer closes a ticket, they are stepped through each required type and prompted to write a note. Each prompt can be skipped.`)
};
...
**Solicitudes al cierre.** Los tipos de nota pueden marcarse como requeridos al cierre. Cuando un voluntario cierra un ticket, se le guia a traves de cada tipo requerido y se le solicita escribir una nota. Cada solicitud se puede omitir.`)
};
