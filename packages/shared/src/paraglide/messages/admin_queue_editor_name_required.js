...
/** @typedef {{}} Admin_Queue_Editor_Name_RequiredInputs */

const en_admin_queue_editor_name_required = /** @type {(inputs: Admin_Queue_Editor_Name_RequiredInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queue name is required`)
};

const es_admin_queue_editor_name_required = /** @type {(inputs: Admin_Queue_Editor_Name_RequiredInputs) => LocalizedString} */ () => {
