...
/** @typedef {{}} Admin_Queues_Create_ButtonInputs */

const en_admin_queues_create_button = /** @type {(inputs: Admin_Queues_Create_ButtonInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Create queue`)
};

const es_admin_queues_create_button = /** @type {(inputs: Admin_Queues_Create_ButtonInputs) => LocalizedString} */ () => {
