...
/** @typedef {{}} Followup_Type_Merge_NoteInputs */

const en_followup_type_merge_note = /** @type {(inputs: Followup_Type_Merge_NoteInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Combined Tickets`)
};

const es_followup_type_merge_note = /** @type {(inputs: Followup_Type_Merge_NoteInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tickets combinados`)
};
