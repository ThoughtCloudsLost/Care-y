...
**On the card.** Chips show the volunteers currently on shift, and an end shift button appears but is not yet functional.`)
};
...
**En la tarjeta.** Chips muestran los voluntarios actualmente en turno, y un botón de terminar turno aparece pero aún no es funcional.`)
};
