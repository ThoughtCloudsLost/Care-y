...
*/
export const demo_narrative_client_quick_exit_heading = /** @type {((inputs?: Demo_Narrative_Client_Quick_Exit_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Client_Quick_Exit_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
