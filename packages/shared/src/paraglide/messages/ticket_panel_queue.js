...
/** @typedef {{}} Ticket_Panel_QueueInputs */

const en_ticket_panel_queue = /** @type {(inputs: Ticket_Panel_QueueInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queue`)
};

const es_ticket_panel_queue = /** @type {(inputs: Ticket_Panel_QueueInputs) => LocalizedString} */ () => {
