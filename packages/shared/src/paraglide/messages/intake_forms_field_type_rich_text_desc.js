...
*/
export const intake_forms_field_type_rich_text_desc = /** @type {((inputs?: Intake_Forms_Field_Type_Rich_Text_DescInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Intake_Forms_Field_Type_Rich_Text_DescInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_intake_forms_field_type_rich_text_desc(inputs)
	return es_intake_forms_field_type_rich_text_desc(inputs)
});