...
/** @typedef {{}} Error_Alias_Generation_FailedInputs */

const en_error_alias_generation_failed = /** @type {(inputs: Error_Alias_Generation_FailedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Could not generate a unique client alias. Please try again.`)
};

const es_error_alias_generation_failed = /** @type {(inputs: Error_Alias_Generation_FailedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`No se pudo generar un alias único para el cliente. Inténtalo de nuevo.`)
};
