...
/** @typedef {{}} Error_Cannot_Take_Closed_TicketInputs */

const en_error_cannot_take_closed_ticket = /** @type {(inputs: Error_Cannot_Take_Closed_TicketInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Cannot take a closed ticket.`)
};

const es_error_cannot_take_closed_ticket = /** @type {(inputs: Error_Cannot_Take_Closed_TicketInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`No se puede tomar un ticket cerrado.`)
};
