...
/** @typedef {{}} Admin_Queues_TitleInputs */

const en_admin_queues_title = /** @type {(inputs: Admin_Queues_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queues`)
};

const es_admin_queues_title = /** @type {(inputs: Admin_Queues_TitleInputs) => LocalizedString} */ () => {
