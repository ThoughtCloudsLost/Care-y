...
/** @typedef {{}} Ticket_New_SubmitInputs */

const en_ticket_new_submit = /** @type {(inputs: Ticket_New_SubmitInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Create Ticket`)
};

const es_ticket_new_submit = /** @type {(inputs: Ticket_New_SubmitInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Crear Ticket`)
};
