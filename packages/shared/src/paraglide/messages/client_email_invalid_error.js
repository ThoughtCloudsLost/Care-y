...
*/
export const client_email_invalid_error = /** @type {((inputs?: Client_Email_Invalid_ErrorInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Client_Email_Invalid_ErrorInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_client_email_invalid_error(inputs)
	return es_client_email_invalid_error(inputs)
});