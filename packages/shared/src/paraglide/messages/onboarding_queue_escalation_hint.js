...
/** @typedef {{}} Onboarding_Queue_Escalation_HintInputs */

const en_onboarding_queue_escalation_hint = /** @type {(inputs: Onboarding_Queue_Escalation_HintInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Days before an unresolved ticket is flagged. 1 to 365.`)
};

const es_onboarding_queue_escalation_hint = /** @type {(inputs: Onboarding_Queue_Escalation_HintInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Dias antes de que un ticket sin resolver sea marcado. 1 a 365.`)
};
