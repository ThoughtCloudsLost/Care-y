...
*/
export const demo_narrative_dashboard_merge_candidates_heading = /** @type {((inputs?: Demo_Narrative_Dashboard_Merge_Candidates_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Dashboard_Merge_Candidates_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
