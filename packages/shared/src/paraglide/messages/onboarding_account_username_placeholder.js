...
*/
export const onboarding_account_username_placeholder = /** @type {((inputs?: Onboarding_Account_Username_PlaceholderInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Account_Username_PlaceholderInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_onboarding_account_username_placeholder(inputs)
	return es_onboarding_account_username_placeholder(inputs)
});