...
/** @typedef {{}} Search_Section_VolunteersInputs */

const en_search_section_volunteers = /** @type {(inputs: Search_Section_VolunteersInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Volunteers`)
};

const es_search_section_volunteers = /** @type {(inputs: Search_Section_VolunteersInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Voluntarios`)
};
