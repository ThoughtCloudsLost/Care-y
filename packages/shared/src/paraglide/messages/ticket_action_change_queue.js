...
/** @typedef {{}} Ticket_Action_Change_QueueInputs */

const en_ticket_action_change_queue = /** @type {(inputs: Ticket_Action_Change_QueueInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Change queue`)
};

const es_ticket_action_change_queue = /** @type {(inputs: Ticket_Action_Change_QueueInputs) => LocalizedString} */ () => {
