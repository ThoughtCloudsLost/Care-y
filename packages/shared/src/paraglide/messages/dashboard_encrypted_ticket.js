...
/** @typedef {{}} Dashboard_Encrypted_TicketInputs */

const en_dashboard_encrypted_ticket = /** @type {(inputs: Dashboard_Encrypted_TicketInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Encrypted ticket`)
};

const es_dashboard_encrypted_ticket = /** @type {(inputs: Dashboard_Encrypted_TicketInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket cifrado`)
};
