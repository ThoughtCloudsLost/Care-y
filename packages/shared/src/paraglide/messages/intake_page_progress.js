...
const en_xa2_intake_page_progress = /** @type {(inputs: Intake_Page_ProgressInputs) => LocalizedString} */ (i) => {
...
*/
export const intake_page_progress = /** @type {((inputs: Intake_Page_ProgressInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Intake_Page_ProgressInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_intake_page_progress(inputs)
	if (locale === "en-XA") return en_xa2_intake_page_progress(inputs)
