...
**Reacciones.** Los voluntarios pueden anadir reacciones a las notas. Cinco tipos de reaccion estan disponibles: reconocer, aprobar, discrepar, marcar y completar. Las reacciones son metadatos en texto plano visibles para todos los voluntarios que pueden ver la nota, y no estan disponibles en mensajes del cliente.`)
};
