...
/** @typedef {{}} Ticket_Toast_UnassignedInputs */

const en_ticket_toast_unassigned = /** @type {(inputs: Ticket_Toast_UnassignedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket unassigned`)
};

const es_ticket_toast_unassigned = /** @type {(inputs: Ticket_Toast_UnassignedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket sin asignar`)
};
