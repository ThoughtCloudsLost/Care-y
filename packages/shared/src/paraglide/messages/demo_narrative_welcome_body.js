...
const en_demo_narrative_welcome_body = /** @type {(inputs: Demo_Narrative_Welcome_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tap a feature in the list or use the tabs inside the phone to explore. Every piece of data you see is encrypted on the client before it reaches the server. The server never holds your keys.`)
};
