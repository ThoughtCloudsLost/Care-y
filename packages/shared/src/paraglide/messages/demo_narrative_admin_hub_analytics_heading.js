...
const en_xa2_demo_narrative_admin_hub_analytics_heading = /** @type {(inputs: Demo_Narrative_Admin_Hub_Analytics_HeadingInputs) => LocalizedString} */ () => {
...
*/
export const demo_narrative_admin_hub_analytics_heading = /** @type {((inputs?: Demo_Narrative_Admin_Hub_Analytics_HeadingInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Admin_Hub_Analytics_HeadingInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_demo_narrative_admin_hub_analytics_heading(inputs)
	if (locale === "en-XA") return en_xa2_demo_narrative_admin_hub_analytics_heading(inputs)
