...
const en_xa2_demo_narrative_topic_email_thread_heading = /** @type {(inputs: Demo_Narrative_Topic_Email_Thread_HeadingInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Èmàìl ìn thè cònvèrsàtìòn ••••••••⟧`)
};
...
*/
export const demo_narrative_topic_email_thread_heading = /** @type {((inputs?: Demo_Narrative_Topic_Email_Thread_HeadingInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Topic_Email_Thread_HeadingInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_demo_narrative_topic_email_thread_heading(inputs)
	if (locale === "en-XA") return en_xa2_demo_narrative_topic_email_thread_heading(inputs)
