...
/** @typedef {{}} Admin_Users_Filter_QueueInputs */

const en_admin_users_filter_queue = /** @type {(inputs: Admin_Users_Filter_QueueInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queue`)
};

const es_admin_users_filter_queue = /** @type {(inputs: Admin_Users_Filter_QueueInputs) => LocalizedString} */ () => {
