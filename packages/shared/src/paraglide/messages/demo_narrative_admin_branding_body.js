...
**Contrast.** The branding editor checks each brand color against WCAG AA contrast requirements and adjusts it at runtime when needed, in both light and dark mode. A color that sits too close to the care or urgent semantic hues draws a notice offering a nudged value, though saving with the original is always allowed. The color changes preview live across the interface while the sheet is open and revert on dismiss.
