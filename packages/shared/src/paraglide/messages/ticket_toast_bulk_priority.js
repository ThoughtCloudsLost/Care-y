...
*/
export const ticket_toast_bulk_priority = /** @type {((inputs: Ticket_Toast_Bulk_PriorityInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Ticket_Toast_Bulk_PriorityInputs, { locale?: "en" | "es" }, {}>} */ ((inputs, options = {}) => {
