...
*/
export const admin_queue_watcher_picker_no_results = /** @type {((inputs?: Admin_Queue_Watcher_Picker_No_ResultsInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Queue_Watcher_Picker_No_ResultsInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
