...
const en_xa2_permission_view_cases = /** @type {(inputs: Permission_View_CasesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Vìèw càsès •••⟧`)
};
...
*/
export const permission_view_cases = /** @type {((inputs?: Permission_View_CasesInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Permission_View_CasesInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_permission_view_cases(inputs)
	if (locale === "en-XA") return en_xa2_permission_view_cases(inputs)
