...
const en_xa2_intake_protected_volunteers_what = /** @type {(inputs: Intake_Protected_Volunteers_WhatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Ùntìl à vòlùntèèr fìrst òpèns yòùr càsè, thè òrgànìzàtìòn càn ùnlòck whàt yòù wròtè. Fròm thèn òn, ònly thè vòlùntèèrs wòrkìng òn yòùr càsè càn rèàd ìt. ••••••••••••••••••••••••••••••••••••••••••••••⟧`)
};
...
*/
export const intake_protected_volunteers_what = /** @type {((inputs?: Intake_Protected_Volunteers_WhatInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Intake_Protected_Volunteers_WhatInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_intake_protected_volunteers_what(inputs)
	if (locale === "en-XA") return en_xa2_intake_protected_volunteers_what(inputs)
