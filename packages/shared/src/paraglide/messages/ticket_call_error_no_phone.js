...
/** @typedef {{}} Ticket_Call_Error_No_PhoneInputs */

const en_ticket_call_error_no_phone = /** @type {(inputs: Ticket_Call_Error_No_PhoneInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`No phone number on file for this client.`)
};

const es_ticket_call_error_no_phone = /** @type {(inputs: Ticket_Call_Error_No_PhoneInputs) => LocalizedString} */ () => {
