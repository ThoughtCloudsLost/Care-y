...
const en_xa2_call_status_failed = /** @type {(inputs: Call_Status_FailedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Càll fàìlèd ••••⟧`)
};
...
*/
export const call_status_failed = /** @type {((inputs?: Call_Status_FailedInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Call_Status_FailedInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_call_status_failed(inputs)
	if (locale === "en-XA") return en_xa2_call_status_failed(inputs)
