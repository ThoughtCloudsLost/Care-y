...
**Notas de resolución.** Al cerrar, el sistema verifica qué tipos de nota están marcados como requeridos al cierre. Si hay alguno, el voluntario los recorre uno a uno. Cada paso se puede omitir. Si ningún tipo de nota requiere notas al cerrar, el ticket se cierra inmediatamente sin solicitud. Las notas de resolución se cifran con la clave por ticket antes de almacenarse.
