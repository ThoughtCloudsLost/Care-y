...
*/
export const demo_narrative_admin_response_export_heading = /** @type {((inputs?: Demo_Narrative_Admin_Response_Export_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Admin_Response_Export_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
