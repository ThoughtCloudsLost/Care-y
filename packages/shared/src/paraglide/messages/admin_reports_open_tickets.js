...
/** @typedef {{}} Admin_Reports_Open_TicketsInputs */

const en_admin_reports_open_tickets = /** @type {(inputs: Admin_Reports_Open_TicketsInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Open tickets`)
};

const es_admin_reports_open_tickets = /** @type {(inputs: Admin_Reports_Open_TicketsInputs) => LocalizedString} */ () => {
