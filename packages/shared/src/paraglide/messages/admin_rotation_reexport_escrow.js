...
const en_xa2_admin_rotation_reexport_escrow = /** @type {(inputs: Admin_Rotation_Reexport_EscrowInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Yòùr rècòvèry fìlè prèdàtès thìs kèy. Èxpòrt à nèw ònè tò kèèp ìt cùrrènt. •••••••••••••••••••••••⟧`)
};
...
*/
export const admin_rotation_reexport_escrow = /** @type {((inputs?: Admin_Rotation_Reexport_EscrowInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Rotation_Reexport_EscrowInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_admin_rotation_reexport_escrow(inputs)
	if (locale === "en-XA") return en_xa2_admin_rotation_reexport_escrow(inputs)
