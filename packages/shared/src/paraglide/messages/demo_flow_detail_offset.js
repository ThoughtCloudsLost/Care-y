...
const en_xa2_demo_flow_detail_offset = /** @type {(inputs: Demo_Flow_Detail_OffsetInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`⟦+ •${i?.ms} ms •⟧`)
};
...
*/
export const demo_flow_detail_offset = /** @type {((inputs: Demo_Flow_Detail_OffsetInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Flow_Detail_OffsetInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_demo_flow_detail_offset(inputs)
	if (locale === "en-XA") return en_xa2_demo_flow_detail_offset(inputs)
