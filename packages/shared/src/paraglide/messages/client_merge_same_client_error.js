...
const en_xa2_client_merge_same_client_error = /** @type {(inputs: Client_Merge_Same_Client_ErrorInputs) => LocalizedString} */ (i) => {
...
*/
export const client_merge_same_client_error = /** @type {((inputs: Client_Merge_Same_Client_ErrorInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Client_Merge_Same_Client_ErrorInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_client_merge_same_client_error(inputs)
	if (locale === "en-XA") return en_xa2_client_merge_same_client_error(inputs)
