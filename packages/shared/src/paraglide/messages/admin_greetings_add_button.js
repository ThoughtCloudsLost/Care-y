...
const en_xa2_admin_greetings_add_button = /** @type {(inputs: Admin_Greetings_Add_ButtonInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Àdd grèètìng ••••⟧`)
};
...
*/
export const admin_greetings_add_button = /** @type {((inputs?: Admin_Greetings_Add_ButtonInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Greetings_Add_ButtonInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_admin_greetings_add_button(inputs)
	if (locale === "en-XA") return en_xa2_admin_greetings_add_button(inputs)
