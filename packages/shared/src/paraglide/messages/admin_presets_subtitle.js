...
const en_xa2_admin_presets_subtitle = /** @type {(inputs: Admin_Presets_SubtitleInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`⟦Rèùsàblè rèply tèmplàtès fòr  •••••••••${i?.volunteers}⟧`)
};
...
*/
export const admin_presets_subtitle = /** @type {((inputs: Admin_Presets_SubtitleInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Presets_SubtitleInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_admin_presets_subtitle(inputs)
	if (locale === "en-XA") return en_xa2_admin_presets_subtitle(inputs)
