...
const es_demo_narrative_admin_queues_body = /** @type {(inputs: Demo_Narrative_Admin_Queues_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Las colas controlan cómo se organizan y enrutan los tickets. Los administradores crean colas, asignan voluntarios a ellas y configuran el orden y la apariencia.
