...
const en_demo_narrative_admin_queues_body = /** @type {(inputs: Demo_Narrative_Admin_Queues_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queues control how tickets are organized and routed. Creating queues, assigning users to them, and configuring their sort order and appearance all happen from this tab.
...
const es_demo_narrative_admin_queues_body = /** @type {(inputs: Demo_Narrative_Admin_Queues_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Las colas controlan cómo se organizan y enrutan los tickets. Crear colas, asignar personas a ellas y configurar su orden y apariencia se hace desde esta pestaña.
