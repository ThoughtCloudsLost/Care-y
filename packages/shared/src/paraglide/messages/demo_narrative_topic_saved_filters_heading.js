...
*/
export const demo_narrative_topic_saved_filters_heading = /** @type {((inputs?: Demo_Narrative_Topic_Saved_Filters_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Topic_Saved_Filters_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_demo_narrative_topic_saved_filters_heading(inputs)
	return es_demo_narrative_topic_saved_filters_heading(inputs)
});