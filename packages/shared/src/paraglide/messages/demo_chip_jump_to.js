...
*/
export const demo_chip_jump_to = /** @type {((inputs: Demo_Chip_Jump_ToInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Chip_Jump_ToInputs, { locale?: "en" | "es" }, {}>} */ ((inputs, options = {}) => {
