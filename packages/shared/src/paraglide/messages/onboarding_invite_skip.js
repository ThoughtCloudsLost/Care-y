...
/** @typedef {{}} Onboarding_Invite_SkipInputs */

const en_onboarding_invite_skip = /** @type {(inputs: Onboarding_Invite_SkipInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`I'll invite volunteers later`)
};

const es_onboarding_invite_skip = /** @type {(inputs: Onboarding_Invite_SkipInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Invitare voluntarios despues`)
};
