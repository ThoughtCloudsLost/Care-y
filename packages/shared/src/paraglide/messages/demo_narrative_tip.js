...
const en_demo_narrative_tip = /** @type {(inputs: Demo_Narrative_TipInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Select a feature above, scroll down, or interact with the CARE-Y app in the phone to learn more about what it can do.`)
};

const es_demo_narrative_tip = /** @type {(inputs: Demo_Narrative_TipInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Selecciona una funcion arriba, desplazate hacia abajo o interactua con la aplicacion CARE-Y en el telefono para conocer lo que puede hacer.`)
};

/**
* | output |
* | --- |
* | "Select a feature above, scroll down, or interact with the CARE-Y app in the phone to learn more about what it can do." |
*
