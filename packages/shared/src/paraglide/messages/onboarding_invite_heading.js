...
/** @typedef {{}} Onboarding_Invite_HeadingInputs */

const en_onboarding_invite_heading = /** @type {(inputs: Onboarding_Invite_HeadingInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Invite Volunteers`)
};

const es_onboarding_invite_heading = /** @type {(inputs: Onboarding_Invite_HeadingInputs) => LocalizedString} */ () => {
