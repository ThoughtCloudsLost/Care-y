...
/** @typedef {{}} Followup_Type_Assignment_Change_DescInputs */

const en_followup_type_assignment_change_desc = /** @type {(inputs: Followup_Type_Assignment_Change_DescInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket assigned, taken, or released`)
};

const es_followup_type_assignment_change_desc = /** @type {(inputs: Followup_Type_Assignment_Change_DescInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket asignado, tomado o liberado`)
};
