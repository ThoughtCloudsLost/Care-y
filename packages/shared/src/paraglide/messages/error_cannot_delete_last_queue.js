...
/** @typedef {{}} Error_Cannot_Delete_Last_QueueInputs */

const en_error_cannot_delete_last_queue = /** @type {(inputs: Error_Cannot_Delete_Last_QueueInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Cannot delete the last queue.`)
};

const es_error_cannot_delete_last_queue = /** @type {(inputs: Error_Cannot_Delete_Last_QueueInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`No se puede eliminar la última cola.`)
};
