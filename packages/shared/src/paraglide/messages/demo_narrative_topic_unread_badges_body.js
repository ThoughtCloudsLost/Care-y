...
**How read state works.** The server tracks which messages each volunteer has seen. This metadata is not encrypted because it contains no message content. It only records a timestamp per volunteer per ticket.
