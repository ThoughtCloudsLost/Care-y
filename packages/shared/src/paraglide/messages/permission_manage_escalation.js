...
*/
export const permission_manage_escalation = /** @type {((inputs?: Permission_Manage_EscalationInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Permission_Manage_EscalationInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
