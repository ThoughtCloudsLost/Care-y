...
const en_xa2_admin_escrow_continue = /** @type {(inputs: Admin_Escrow_ContinueInputs) => LocalizedString} */ () => {
...
*/
export const admin_escrow_continue = /** @type {((inputs?: Admin_Escrow_ContinueInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Escrow_ContinueInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_admin_escrow_continue(inputs)
	if (locale === "en-XA") return en_xa2_admin_escrow_continue(inputs)
