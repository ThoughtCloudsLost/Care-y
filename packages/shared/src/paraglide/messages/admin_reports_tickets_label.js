...
/** @typedef {{}} Admin_Reports_Tickets_LabelInputs */

const en_admin_reports_tickets_label = /** @type {(inputs: Admin_Reports_Tickets_LabelInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tickets`)
};

const es_admin_reports_tickets_label = /** @type {(inputs: Admin_Reports_Tickets_LabelInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tickets`)
};
