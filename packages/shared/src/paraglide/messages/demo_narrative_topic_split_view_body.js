...
const es_demo_narrative_topic_split_view_body = /** @type {(inputs: Demo_Narrative_Topic_Split_View_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`En pantallas mas anchas, la lista de tickets soporta una vista dividida donde la lista y un panel de detalle del ticket se sientan lado a lado. Seleccionar un ticket de la lista abre su detalle en el panel derecho sin navegar fuera de la lista.
**Cuando aparece.** La vista dividida se activa automaticamente cuando la pantalla es suficientemente ancha. En movil o ventanas estrechas, tocar un ticket navega a una vista de detalle a pantalla completa.
**Pantalla completa.** Tocar dos veces un ticket lo abre a pantalla completa incluso mientras la vista dividida esta activa.`)
};
