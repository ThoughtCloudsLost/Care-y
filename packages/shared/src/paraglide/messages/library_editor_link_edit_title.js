...
const en_xa2_library_editor_link_edit_title = /** @type {(inputs: Library_Editor_Link_Edit_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Èdìt Lìnk •••⟧`)
};
...
*/
export const library_editor_link_edit_title = /** @type {((inputs?: Library_Editor_Link_Edit_TitleInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Library_Editor_Link_Edit_TitleInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_library_editor_link_edit_title(inputs)
	if (locale === "en-XA") return en_xa2_library_editor_link_edit_title(inputs)
