...
*/
export const demo_narrative_admin_call_log_heading = /** @type {((inputs?: Demo_Narrative_Admin_Call_Log_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Admin_Call_Log_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
