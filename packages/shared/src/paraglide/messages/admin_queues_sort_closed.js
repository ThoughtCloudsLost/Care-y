...
/** @typedef {{ tickets: NonNullable<unknown>, Tickets: NonNullable<unknown> }} Admin_Queues_Sort_ClosedInputs */

const en_admin_queues_sort_closed = /** @type {(inputs: Admin_Queues_Sort_ClosedInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Closed ${i?.tickets}`)
};

const es_admin_queues_sort_closed = /** @type {(inputs: Admin_Queues_Sort_ClosedInputs) => LocalizedString} */ (i) => {
