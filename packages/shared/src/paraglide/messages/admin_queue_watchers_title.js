...
const en_xa2_admin_queue_watchers_title = /** @type {(inputs: Admin_Queue_Watchers_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Wàtchèrs •••⟧`)
};
...
*/
export const admin_queue_watchers_title = /** @type {((inputs?: Admin_Queue_Watchers_TitleInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Queue_Watchers_TitleInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_admin_queue_watchers_title(inputs)
	if (locale === "en-XA") return en_xa2_admin_queue_watchers_title(inputs)
