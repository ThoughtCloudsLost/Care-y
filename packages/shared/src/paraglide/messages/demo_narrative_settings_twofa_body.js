...
**Enrollment flow.** Each method has its own enrollment sheet with setup instructions and verification. The simulator stands in for external devices by auto filling verification codes after a short delay. The server side verification is real.`)
};
...
**Flujo de registro.** Cada metodo tiene su propia ventana de registro con instrucciones de configuracion y verificacion. El simulador sustituye dispositivos externos llenando automaticamente los codigos de verificacion tras una breve pausa. La verificacion del lado del servidor es real.`)
};
