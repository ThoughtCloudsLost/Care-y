...
/** @typedef {{}} Error_Ticket_Not_FoundInputs */

const en_error_ticket_not_found = /** @type {(inputs: Error_Ticket_Not_FoundInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket not found.`)
};

const es_error_ticket_not_found = /** @type {(inputs: Error_Ticket_Not_FoundInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket no encontrado.`)
};
