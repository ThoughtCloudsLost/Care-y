...
/** @typedef {{}} Error_Ticket_Already_AssignedInputs */

const en_error_ticket_already_assigned = /** @type {(inputs: Error_Ticket_Already_AssignedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket is already assigned.`)
};

const es_error_ticket_already_assigned = /** @type {(inputs: Error_Ticket_Already_AssignedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`El ticket ya está asignado.`)
};
