...
*/
export const demo_flow_resize = /** @type {((inputs?: Demo_Flow_ResizeInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Flow_ResizeInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_demo_flow_resize(inputs)
	return es_demo_flow_resize(inputs)
});