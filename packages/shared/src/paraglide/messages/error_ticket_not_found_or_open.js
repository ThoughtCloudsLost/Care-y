...
/** @typedef {{}} Error_Ticket_Not_Found_Or_OpenInputs */

const en_error_ticket_not_found_or_open = /** @type {(inputs: Error_Ticket_Not_Found_Or_OpenInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket not found or already open.`)
};

const es_error_ticket_not_found_or_open = /** @type {(inputs: Error_Ticket_Not_Found_Or_OpenInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket no encontrado o ya abierto.`)
};
