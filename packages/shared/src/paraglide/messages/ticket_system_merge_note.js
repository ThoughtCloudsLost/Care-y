...
/** @typedef {{ Tickets: NonNullable<unknown> }} Ticket_System_Merge_NoteInputs */

const en_ticket_system_merge_note = /** @type {(inputs: Ticket_System_Merge_NoteInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.Tickets} merged`)
};

const es_ticket_system_merge_note = /** @type {(inputs: Ticket_System_Merge_NoteInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.Tickets} fusionados`)
};
