...
/** @typedef {{}} Admin_Queue_Delete_Reassign_LabelInputs */

const en_admin_queue_delete_reassign_label = /** @type {(inputs: Admin_Queue_Delete_Reassign_LabelInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Move tickets to`)
};

const es_admin_queue_delete_reassign_label = /** @type {(inputs: Admin_Queue_Delete_Reassign_LabelInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Mover tickets a`)
};
