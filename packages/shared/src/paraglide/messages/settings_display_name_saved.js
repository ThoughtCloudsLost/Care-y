...
const en_xa2_settings_display_name_saved = /** @type {(inputs: Settings_Display_Name_SavedInputs) => LocalizedString} */ () => {
...
*/
export const settings_display_name_saved = /** @type {((inputs?: Settings_Display_Name_SavedInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Settings_Display_Name_SavedInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_settings_display_name_saved(inputs)
	if (locale === "en-XA") return en_xa2_settings_display_name_saved(inputs)
