...
*/
export const permission_manage_channel_routing = /** @type {((inputs?: Permission_Manage_Channel_RoutingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Permission_Manage_Channel_RoutingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
