...
const en_xa2_portal_incomplete_link_title = /** @type {(inputs: Portal_Incomplete_Link_TitleInputs) => LocalizedString} */ () => {
...
*/
export const portal_incomplete_link_title = /** @type {((inputs?: Portal_Incomplete_Link_TitleInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Portal_Incomplete_Link_TitleInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_portal_incomplete_link_title(inputs)
	if (locale === "en-XA") return en_xa2_portal_incomplete_link_title(inputs)
