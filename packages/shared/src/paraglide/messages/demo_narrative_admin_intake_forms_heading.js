...
*/
export const demo_narrative_admin_intake_forms_heading = /** @type {((inputs?: Demo_Narrative_Admin_Intake_Forms_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Admin_Intake_Forms_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
