...
**What the server holds.** Your email address is stored under the server's operational encryption rather than end-to-end encryption. This is a deliberate exception: the server must be able to read the address in order to send the code.
**Security tradeoff.** The security of this method matches the security of your mailbox.`)
};
