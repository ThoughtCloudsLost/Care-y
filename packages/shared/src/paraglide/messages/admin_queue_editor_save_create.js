...
/** @typedef {{}} Admin_Queue_Editor_Save_CreateInputs */

const en_admin_queue_editor_save_create = /** @type {(inputs: Admin_Queue_Editor_Save_CreateInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Save queue`)
};

const es_admin_queue_editor_save_create = /** @type {(inputs: Admin_Queue_Editor_Save_CreateInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Guardar cola`)
};
