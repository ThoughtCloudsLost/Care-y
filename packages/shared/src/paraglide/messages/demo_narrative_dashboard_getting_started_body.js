...
**Visibility.** Volunteers and managers never see this card because it requires the administrator role, which is why switching the handbook to a different role hides it.`)
};
...
**Visibilidad.** Los voluntarios y gestores nunca ven esta tarjeta porque requiere el rol de administrador, por lo que cambiar el manual a un rol diferente la oculta.`)
};
