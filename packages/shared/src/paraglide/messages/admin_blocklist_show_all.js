...
*/
export const admin_blocklist_show_all = /** @type {((inputs: Admin_Blocklist_Show_AllInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Blocklist_Show_AllInputs, { locale?: "en" | "es" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_admin_blocklist_show_all(inputs)
	return es_admin_blocklist_show_all(inputs)
});