...
/** @typedef {{}} Admin_Branding_Card_Text_LabelInputs */

const en_admin_branding_card_text_label = /** @type {(inputs: Admin_Branding_Card_Text_LabelInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Client welcome text`)
};

const es_admin_branding_card_text_label = /** @type {(inputs: Admin_Branding_Card_Text_LabelInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Texto de bienvenida para clientes`)
};
