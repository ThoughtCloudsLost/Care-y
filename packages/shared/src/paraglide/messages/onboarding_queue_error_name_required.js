...
/** @typedef {{ Queue: NonNullable<unknown>, queue: NonNullable<unknown> }} Onboarding_Queue_Error_Name_RequiredInputs */

const en_onboarding_queue_error_name_required = /** @type {(inputs: Onboarding_Queue_Error_Name_RequiredInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.Queue} name is required.`)
};

const es_onboarding_queue_error_name_required = /** @type {(inputs: Onboarding_Queue_Error_Name_RequiredInputs) => LocalizedString} */ (i) => {
