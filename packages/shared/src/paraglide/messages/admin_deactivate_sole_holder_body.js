...
*/
export const admin_deactivate_sole_holder_body = /** @type {((inputs?: Admin_Deactivate_Sole_Holder_BodyInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Deactivate_Sole_Holder_BodyInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
