...
*/
export const ticket_tier_last_seen_at = /** @type {((inputs: Ticket_Tier_Last_Seen_AtInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Ticket_Tier_Last_Seen_AtInputs, { locale?: "en" | "es" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_ticket_tier_last_seen_at(inputs)
	return es_ticket_tier_last_seen_at(inputs)
});