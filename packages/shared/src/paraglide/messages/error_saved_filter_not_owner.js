...
*/
export const error_saved_filter_not_owner = /** @type {((inputs?: Error_Saved_Filter_Not_OwnerInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Error_Saved_Filter_Not_OwnerInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
