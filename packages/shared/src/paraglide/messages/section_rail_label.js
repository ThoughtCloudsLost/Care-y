...
const en_xa2_section_rail_label = /** @type {(inputs: Section_Rail_LabelInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Pàgè sèctìòns ••••⟧`)
};
...
*/
export const section_rail_label = /** @type {((inputs?: Section_Rail_LabelInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Section_Rail_LabelInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_section_rail_label(inputs)
	if (locale === "en-XA") return en_xa2_section_rail_label(inputs)
