...
/** @typedef {{}} Onboarding_Account_Display_Name_InfoInputs */

const en_onboarding_account_display_name_info = /** @type {(inputs: Onboarding_Account_Display_Name_InfoInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Visible to other volunteers in your organization.`)
};

const es_onboarding_account_display_name_info = /** @type {(inputs: Onboarding_Account_Display_Name_InfoInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Visible para otros voluntarios en tu organizacion.`)
};
