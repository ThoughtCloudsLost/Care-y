...
/** @typedef {{}} Admin_Queue_Member_Picker_EmptyInputs */

const en_admin_queue_member_picker_empty = /** @type {(inputs: Admin_Queue_Member_Picker_EmptyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`No volunteers available to add`)
};

const es_admin_queue_member_picker_empty = /** @type {(inputs: Admin_Queue_Member_Picker_EmptyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`No hay voluntarios disponibles para agregar`)
};
