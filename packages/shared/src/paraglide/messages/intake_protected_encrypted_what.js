...
const en_xa2_intake_protected_encrypted_what = /** @type {(inputs: Intake_Protected_Encrypted_WhatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Yòùr ìnfòrmàtìòn ìs èncryptèd ìn yòùr bròwsèr bèfòrè ìt ìs sènt. Thè sèrvèr rècèìvès ònly scràmblèd dàtà ìt cànnòt rèàd. ••••••••••••••••••••••••••••••••••••⟧`)
};
...
*/
export const intake_protected_encrypted_what = /** @type {((inputs?: Intake_Protected_Encrypted_WhatInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Intake_Protected_Encrypted_WhatInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_intake_protected_encrypted_what(inputs)
	if (locale === "en-XA") return en_xa2_intake_protected_encrypted_what(inputs)
	return en_intake_protected_encrypted_what(inputs)
});