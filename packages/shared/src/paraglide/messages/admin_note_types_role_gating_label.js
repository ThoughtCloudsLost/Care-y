...
*/
export const admin_note_types_role_gating_label = /** @type {((inputs?: Admin_Note_Types_Role_Gating_LabelInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Note_Types_Role_Gating_LabelInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_admin_note_types_role_gating_label(inputs)
	return es_admin_note_types_role_gating_label(inputs)
});