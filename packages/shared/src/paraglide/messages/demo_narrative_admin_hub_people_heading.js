...
*/
export const demo_narrative_admin_hub_people_heading = /** @type {((inputs?: Demo_Narrative_Admin_Hub_People_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Admin_Hub_People_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
