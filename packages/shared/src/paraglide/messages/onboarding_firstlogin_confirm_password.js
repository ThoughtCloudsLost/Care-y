...
/** @typedef {{}} Onboarding_Firstlogin_Confirm_PasswordInputs */

const en_onboarding_firstlogin_confirm_password = /** @type {(inputs: Onboarding_Firstlogin_Confirm_PasswordInputs) => LocalizedString} */ () => {
...
export const onboarding_firstlogin_confirm_password = /** @type {((inputs?: Onboarding_Firstlogin_Confirm_PasswordInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Firstlogin_Confirm_PasswordInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_firstlogin_confirm_password(inputs)
	return es_onboarding_firstlogin_confirm_password(inputs)
});