...
*/
export const demo_narrative_admin_note_types_heading = /** @type {((inputs?: Demo_Narrative_Admin_Note_Types_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Admin_Note_Types_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_demo_narrative_admin_note_types_heading(inputs)
	return es_demo_narrative_admin_note_types_heading(inputs)
});