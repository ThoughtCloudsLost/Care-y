...
const en_xa2_intake_avail_recurring_count = /** @type {(inputs: Intake_Avail_Recurring_CountInputs) => LocalizedString} */ (i) => {
...
*/
export const intake_avail_recurring_count = /** @type {((inputs: Intake_Avail_Recurring_CountInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Intake_Avail_Recurring_CountInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_intake_avail_recurring_count(inputs)
	if (locale === "en-XA") return en_xa2_intake_avail_recurring_count(inputs)
