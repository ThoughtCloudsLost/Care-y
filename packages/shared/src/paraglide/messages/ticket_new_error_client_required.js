...
/** @typedef {{}} Ticket_New_Error_Client_RequiredInputs */

const en_ticket_new_error_client_required = /** @type {(inputs: Ticket_New_Error_Client_RequiredInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Select or create a client`)
};

const es_ticket_new_error_client_required = /** @type {(inputs: Ticket_New_Error_Client_RequiredInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Selecciona o crea un cliente`)
};
