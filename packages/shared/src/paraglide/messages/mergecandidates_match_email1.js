...
*/
const mergecandidates_match_email1 = /** @type {((inputs?: Mergecandidates_Match_Email1Inputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Mergecandidates_Match_Email1Inputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_mergecandidates_match_email1(inputs)
	return es_mergecandidates_match_email1(inputs)
});
