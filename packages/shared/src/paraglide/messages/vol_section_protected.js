...
const en_xa2_vol_section_protected = /** @type {(inputs: Vol_Section_ProtectedInputs) => LocalizedString} */ () => {
...
*/
export const vol_section_protected = /** @type {((inputs?: Vol_Section_ProtectedInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Vol_Section_ProtectedInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_vol_section_protected(inputs)
	if (locale === "en-XA") return en_xa2_vol_section_protected(inputs)
