...
const en_xa2_admin_presets_queue_label = /** @type {(inputs: Admin_Presets_Queue_LabelInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`⟦${i?.Queue} (òptìònàl) ••••⟧`)
};
...
*/
export const admin_presets_queue_label = /** @type {((inputs: Admin_Presets_Queue_LabelInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Presets_Queue_LabelInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_admin_presets_queue_label(inputs)
	if (locale === "en-XA") return en_xa2_admin_presets_queue_label(inputs)
