...
/** @typedef {{ client: NonNullable<unknown>, ticket: NonNullable<unknown> }} Error_Merge_Unresolved_DepsInputs */

const en_error_merge_unresolved_deps = /** @type {(inputs: Error_Merge_Unresolved_DepsInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Cannot merge: the secondary ${i?.client}'s ${i?.ticket} has unresolved dependencies.`)
};

const es_error_merge_unresolved_deps = /** @type {(inputs: Error_Merge_Unresolved_DepsInputs) => LocalizedString} */ (i) => {
