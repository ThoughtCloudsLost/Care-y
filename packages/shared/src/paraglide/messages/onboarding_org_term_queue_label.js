...
*/
export const onboarding_org_term_queue_label = /** @type {((inputs?: Onboarding_Org_Term_Queue_LabelInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Org_Term_Queue_LabelInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_onboarding_org_term_queue_label(inputs)
	return es_onboarding_org_term_queue_label(inputs)
});