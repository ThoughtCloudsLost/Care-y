...
*/
export const demo_narrative_client_account_thread_heading = /** @type {((inputs?: Demo_Narrative_Client_Account_Thread_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Client_Account_Thread_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
