...
const en_xa2_demo_narrative_settings_security_heading = /** @type {(inputs: Demo_Narrative_Settings_Security_HeadingInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Sècùrìty brìèfìng ••••••⟧`)
};
...
*/
export const demo_narrative_settings_security_heading = /** @type {((inputs?: Demo_Narrative_Settings_Security_HeadingInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Settings_Security_HeadingInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_demo_narrative_settings_security_heading(inputs)
	if (locale === "en-XA") return en_xa2_demo_narrative_settings_security_heading(inputs)
	return en_demo_narrative_settings_security_heading(inputs)
});