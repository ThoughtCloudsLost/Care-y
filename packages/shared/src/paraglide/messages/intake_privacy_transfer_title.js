...
*/
export const intake_privacy_transfer_title = /** @type {((inputs?: Intake_Privacy_Transfer_TitleInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Intake_Privacy_Transfer_TitleInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_intake_privacy_transfer_title(inputs)
	return es_intake_privacy_transfer_title(inputs)
});