...
*/
export const demo_narrative_admin_sms_templates_heading = /** @type {((inputs?: Demo_Narrative_Admin_Sms_Templates_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Admin_Sms_Templates_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_demo_narrative_admin_sms_templates_heading(inputs)
	return es_demo_narrative_admin_sms_templates_heading(inputs)
});