...
*/
export const admin_terminology_support_label_hint = /** @type {((inputs?: Admin_Terminology_Support_Label_HintInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Terminology_Support_Label_HintInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_admin_terminology_support_label_hint(inputs)
	return es_admin_terminology_support_label_hint(inputs)
});