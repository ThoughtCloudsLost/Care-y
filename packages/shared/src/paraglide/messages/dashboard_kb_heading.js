...
/** @typedef {{}} Dashboard_Kb_HeadingInputs */

const en_dashboard_kb_heading = /** @type {(inputs: Dashboard_Kb_HeadingInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Knowledge Base`)
};

const es_dashboard_kb_heading = /** @type {(inputs: Dashboard_Kb_HeadingInputs) => LocalizedString} */ () => {
