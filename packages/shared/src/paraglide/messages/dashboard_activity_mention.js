...
*/
export const dashboard_activity_mention = /** @type {((inputs?: Dashboard_Activity_MentionInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Dashboard_Activity_MentionInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_dashboard_activity_mention(inputs)
	return es_dashboard_activity_mention(inputs)
});