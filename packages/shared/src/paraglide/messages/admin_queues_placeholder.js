...
/** @typedef {{}} Admin_Queues_PlaceholderInputs */

const en_admin_queues_placeholder = /** @type {(inputs: Admin_Queues_PlaceholderInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queue management loading...`)
};

const es_admin_queues_placeholder = /** @type {(inputs: Admin_Queues_PlaceholderInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Cargando gestion de colas...`)
};
