...
*/
export const admin_invite_identifier_pii_warning = /** @type {((inputs?: Admin_Invite_Identifier_Pii_WarningInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Invite_Identifier_Pii_WarningInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_admin_invite_identifier_pii_warning(inputs)
	return es_admin_invite_identifier_pii_warning(inputs)
});