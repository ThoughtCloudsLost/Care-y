...
const en_xa2_dashboard_kb_vote_count_other = /** @type {(inputs: Dashboard_Kb_Vote_Count_OtherInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`⟦${i?.count} vòtès ••⟧`)
};
...
*/
export const dashboard_kb_vote_count_other = /** @type {((inputs: Dashboard_Kb_Vote_Count_OtherInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Dashboard_Kb_Vote_Count_OtherInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_dashboard_kb_vote_count_other(inputs)
	if (locale === "en-XA") return en_xa2_dashboard_kb_vote_count_other(inputs)
