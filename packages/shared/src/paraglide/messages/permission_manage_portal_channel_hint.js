...
*/
export const permission_manage_portal_channel_hint = /** @type {((inputs?: Permission_Manage_Portal_Channel_HintInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Permission_Manage_Portal_Channel_HintInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
