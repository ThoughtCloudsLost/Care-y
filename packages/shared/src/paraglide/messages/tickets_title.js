...
/** @typedef {{}} Tickets_TitleInputs */

const en_tickets_title = /** @type {(inputs: Tickets_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tickets`)
};

const es_tickets_title = /** @type {(inputs: Tickets_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tickets`)
};
