...
*/
export const demo_narrative_topic_exposure_hints_heading = /** @type {((inputs?: Demo_Narrative_Topic_Exposure_Hints_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Topic_Exposure_Hints_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_demo_narrative_topic_exposure_hints_heading(inputs)
	return es_demo_narrative_topic_exposure_hints_heading(inputs)
});