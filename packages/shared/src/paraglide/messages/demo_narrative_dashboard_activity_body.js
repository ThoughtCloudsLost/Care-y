...
**What this means for volunteers.** The activity feed gives a quick overview of what is happening across the organization without needing to open individual items, and tapping an event navigates to the relevant one.`)
};
