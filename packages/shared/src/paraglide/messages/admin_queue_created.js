...
/** @typedef {{}} Admin_Queue_CreatedInputs */

const en_admin_queue_created = /** @type {(inputs: Admin_Queue_CreatedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queue created`)
};

const es_admin_queue_created = /** @type {(inputs: Admin_Queue_CreatedInputs) => LocalizedString} */ () => {
