...
*/
export const admin_reports_month_label = /** @type {((inputs?: Admin_Reports_Month_LabelInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Reports_Month_LabelInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_admin_reports_month_label(inputs)
	return es_admin_reports_month_label(inputs)
});