...
/** @typedef {{}} Admin_Role_ManagerInputs */

const en_admin_role_manager = /** @type {(inputs: Admin_Role_ManagerInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Manager`)
};

const es_admin_role_manager = /** @type {(inputs: Admin_Role_ManagerInputs) => LocalizedString} */ () => {
