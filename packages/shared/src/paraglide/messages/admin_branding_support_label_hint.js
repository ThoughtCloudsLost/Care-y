...
const en_xa2_admin_branding_support_label_hint = /** @type {(inputs: Admin_Branding_Support_Label_HintInputs) => LocalizedString} */ () => {
...
*/
export const admin_branding_support_label_hint = /** @type {((inputs?: Admin_Branding_Support_Label_HintInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Branding_Support_Label_HintInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_admin_branding_support_label_hint(inputs)
	if (locale === "en-XA") return en_xa2_admin_branding_support_label_hint(inputs)
