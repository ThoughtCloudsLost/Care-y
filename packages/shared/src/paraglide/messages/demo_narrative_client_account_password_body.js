...
*/
export const demo_narrative_client_account_password_body = /** @type {((inputs?: Demo_Narrative_Client_Account_Password_BodyInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Client_Account_Password_BodyInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
