...
*/
export const client_delete_confirm_body_zero = /** @type {((inputs: Client_Delete_Confirm_Body_ZeroInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Client_Delete_Confirm_Body_ZeroInputs, { locale?: "en" | "es" }, {}>} */ ((inputs, options = {}) => {
