...
const en_xa2_panel_group_organization = /** @type {(inputs: Panel_Group_OrganizationInputs) => LocalizedString} */ () => {
...
*/
export const panel_group_organization = /** @type {((inputs?: Panel_Group_OrganizationInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Panel_Group_OrganizationInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_panel_group_organization(inputs)
	if (locale === "en-XA") return en_xa2_panel_group_organization(inputs)
