...
*/
export const demo_narrative_admin_form_responses_heading = /** @type {((inputs?: Demo_Narrative_Admin_Form_Responses_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Admin_Form_Responses_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
