...
/** @typedef {{}} Role_ManagerInputs */

const en_role_manager = /** @type {(inputs: Role_ManagerInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Manager`)
};

const es_role_manager = /** @type {(inputs: Role_ManagerInputs) => LocalizedString} */ () => {
