...
/** @typedef {{}} Dashboard_Queues_No_QueuesInputs */

const en_dashboard_queues_no_queues = /** @type {(inputs: Dashboard_Queues_No_QueuesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`No queues assigned`)
};

const es_dashboard_queues_no_queues = /** @type {(inputs: Dashboard_Queues_No_QueuesInputs) => LocalizedString} */ () => {
