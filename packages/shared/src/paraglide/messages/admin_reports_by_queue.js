...
/** @typedef {{ queue: NonNullable<unknown> }} Admin_Reports_By_QueueInputs */

const en_admin_reports_by_queue = /** @type {(inputs: Admin_Reports_By_QueueInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`By ${i?.queue}`)
};

const es_admin_reports_by_queue = /** @type {(inputs: Admin_Reports_By_QueueInputs) => LocalizedString} */ (i) => {
