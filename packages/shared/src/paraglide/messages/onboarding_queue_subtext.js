...
/** @typedef {{ Queues: NonNullable<unknown>, queues: NonNullable<unknown> }} Onboarding_Queue_SubtextInputs */

const en_onboarding_queue_subtext = /** @type {(inputs: Onboarding_Queue_SubtextInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.Queues} organize incoming cases by topic or team.`)
};

const es_onboarding_queue_subtext = /** @type {(inputs: Onboarding_Queue_SubtextInputs) => LocalizedString} */ (i) => {
