...
*/
export const error_kb_article_not_found = /** @type {((inputs?: Error_Kb_Article_Not_FoundInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Error_Kb_Article_Not_FoundInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_error_kb_article_not_found(inputs)
	return es_error_kb_article_not_found(inputs)
});