...
*/
export const demo_narrative_settings_twofa_heading = /** @type {((inputs?: Demo_Narrative_Settings_Twofa_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Settings_Twofa_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_demo_narrative_settings_twofa_heading(inputs)
	return es_demo_narrative_settings_twofa_heading(inputs)
});