...
const en_xa2_demo_section_client_intake_title = /** @type {(inputs: Demo_Section_Client_Intake_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Ìntàkè fòrm ••••⟧`)
};
...
*/
export const demo_section_client_intake_title = /** @type {((inputs?: Demo_Section_Client_Intake_TitleInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Section_Client_Intake_TitleInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_demo_section_client_intake_title(inputs)
	if (locale === "en-XA") return en_xa2_demo_section_client_intake_title(inputs)
