...
/** @typedef {{}} Panel_QueuesInputs */

const en_panel_queues = /** @type {(inputs: Panel_QueuesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queues`)
};

const es_panel_queues = /** @type {(inputs: Panel_QueuesInputs) => LocalizedString} */ () => {
