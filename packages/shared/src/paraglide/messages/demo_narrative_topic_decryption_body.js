...
const en_demo_narrative_topic_decryption_body = /** @type {(inputs: Demo_Narrative_Topic_Decryption_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`When the ticket list loads, titles appear as scrambled text that resolves into readable words as the browser decrypts each one.
...
const es_demo_narrative_topic_decryption_body = /** @type {(inputs: Demo_Narrative_Topic_Decryption_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Cuando la lista de tickets se carga, los títulos aparecen como texto desordenado que se resuelve en palabras legibles a medida que el navegador descifra cada uno.
