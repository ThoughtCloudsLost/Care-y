...
const en_xa2_client_alias_changed_toast = /** @type {(inputs: Client_Alias_Changed_ToastInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Àlìàs ùpdàtèd ••••⟧`)
};
...
*/
export const client_alias_changed_toast = /** @type {((inputs?: Client_Alias_Changed_ToastInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Client_Alias_Changed_ToastInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_client_alias_changed_toast(inputs)
	if (locale === "en-XA") return en_xa2_client_alias_changed_toast(inputs)
