...
*/
export const demo_narrative_client_intake_protection_body = /** @type {((inputs?: Demo_Narrative_Client_Intake_Protection_BodyInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Client_Intake_Protection_BodyInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
