...
/** @typedef {{}} Admin_Queue_Editor_Edit_TitleInputs */

const en_admin_queue_editor_edit_title = /** @type {(inputs: Admin_Queue_Editor_Edit_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Edit Queue`)
};

const es_admin_queue_editor_edit_title = /** @type {(inputs: Admin_Queue_Editor_Edit_TitleInputs) => LocalizedString} */ () => {
