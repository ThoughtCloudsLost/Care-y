...
const en_xa2_demo_section_admin_forms_title = /** @type {(inputs: Demo_Section_Admin_Forms_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Fòrm bùìldèr ••••⟧`)
};
...
*/
export const demo_section_admin_forms_title = /** @type {((inputs?: Demo_Section_Admin_Forms_TitleInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Section_Admin_Forms_TitleInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_demo_section_admin_forms_title(inputs)
	if (locale === "en-XA") return en_xa2_demo_section_admin_forms_title(inputs)
