...
*/
export const admin_deactivate_sole_holder_title_other = /** @type {((inputs: Admin_Deactivate_Sole_Holder_Title_OtherInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Deactivate_Sole_Holder_Title_OtherInputs, { locale?: "en" | "es" }, {}>} */ ((inputs, options = {}) => {
