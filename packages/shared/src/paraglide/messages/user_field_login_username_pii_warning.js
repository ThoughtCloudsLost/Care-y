...
const es_user_field_login_username_pii_warning = /** @type {(inputs: User_Field_Login_Username_Pii_WarningInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Los usuarios de inicio de sesión se almacenan con cifrado más debil que los nombres visibles. Evite usar nombres reales o correos electrónicos.`)
};
