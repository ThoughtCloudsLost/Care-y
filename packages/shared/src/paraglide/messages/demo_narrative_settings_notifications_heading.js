...
*/
export const demo_narrative_settings_notifications_heading = /** @type {((inputs?: Demo_Narrative_Settings_Notifications_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Settings_Notifications_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
