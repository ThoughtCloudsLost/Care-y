...
/** @typedef {{}} Tickets_Sort_QueueInputs */

const en_tickets_sort_queue = /** @type {(inputs: Tickets_Sort_QueueInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Queue`)
};

const es_tickets_sort_queue = /** @type {(inputs: Tickets_Sort_QueueInputs) => LocalizedString} */ () => {
