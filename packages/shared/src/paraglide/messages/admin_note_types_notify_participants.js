...
/** @typedef {{}} Admin_Note_Types_Notify_ParticipantsInputs */

const en_admin_note_types_notify_participants = /** @type {(inputs: Admin_Note_Types_Notify_ParticipantsInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ticket participants`)
};

const es_admin_note_types_notify_participants = /** @type {(inputs: Admin_Note_Types_Notify_ParticipantsInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Participantes del ticket`)
};
