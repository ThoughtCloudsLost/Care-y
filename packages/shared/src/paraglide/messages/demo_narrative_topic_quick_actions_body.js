...
**Swipe directions.** Swipe right to reply or start a call. Swipe left to assign or place a ticket on hold. A short swipe peeks the action tray, and a longer swipe fires the action directly.
...
**Direcciones de deslizamiento.** Desliza a la derecha para responder o iniciar una llamada. Desliza a la izquierda para asignar o poner un ticket en espera. Un deslizamiento corto muestra la bandeja de acciones, y un deslizamiento más largo ejecuta la acción directamente.
**Acciones disponibles.** Responder, llamar, asignar y poner en espera. Las acciones específicas mostradas dependen del estado actual del ticket y los permisos del voluntario.
