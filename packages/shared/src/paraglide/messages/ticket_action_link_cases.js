...
const en_xa2_ticket_action_link_cases = /** @type {(inputs: Ticket_Action_Link_CasesInputs) => LocalizedString} */ (i) => {
...
*/
export const ticket_action_link_cases = /** @type {((inputs: Ticket_Action_Link_CasesInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Ticket_Action_Link_CasesInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_ticket_action_link_cases(inputs)
	if (locale === "en-XA") return en_xa2_ticket_action_link_cases(inputs)
