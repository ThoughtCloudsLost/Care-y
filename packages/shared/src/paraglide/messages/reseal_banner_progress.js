...
*/
export const reseal_banner_progress = /** @type {((inputs: Reseal_Banner_ProgressInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Reseal_Banner_ProgressInputs, { locale?: "en" | "es" }, {}>} */ ((inputs, options = {}) => {
