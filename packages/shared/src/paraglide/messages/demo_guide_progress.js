...
*/
export const demo_guide_progress = /** @type {((inputs: Demo_Guide_ProgressInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Guide_ProgressInputs, { locale?: "en" | "es" }, {}>} */ ((inputs, options = {}) => {
