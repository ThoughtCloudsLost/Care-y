...
/** @typedef {{}} Admin_Telephony_Outbound_Calls_HelperInputs */

const en_admin_telephony_outbound_calls_helper = /** @type {(inputs: Admin_Telephony_Outbound_Calls_HelperInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`The number clients see when a volunteer calls them`)
};

const es_admin_telephony_outbound_calls_helper = /** @type {(inputs: Admin_Telephony_Outbound_Calls_HelperInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`El numero que los clientes ven cuando un voluntario les llama`)
};
