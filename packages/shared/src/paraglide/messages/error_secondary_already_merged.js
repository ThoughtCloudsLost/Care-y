...
/** @typedef {{}} Error_Secondary_Already_MergedInputs */

const en_error_secondary_already_merged = /** @type {(inputs: Error_Secondary_Already_MergedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Secondary client is already merged.`)
};

const es_error_secondary_already_merged = /** @type {(inputs: Error_Secondary_Already_MergedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`El cliente secundario ya está fusionado.`)
};
