...
*/
export const demo_narrative_client_portal_composer_heading = /** @type {((inputs?: Demo_Narrative_Client_Portal_Composer_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Client_Portal_Composer_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
