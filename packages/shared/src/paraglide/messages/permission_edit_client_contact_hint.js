...
const en_xa2_permission_edit_client_contact_hint = /** @type {(inputs: Permission_Edit_Client_Contact_HintInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Àpplìès tò còntàct dètàìls òn àny clìènt rècòrd, nòt ònly yòùr òwn càsès. ••••••••••••••••••••••⟧`)
};
...
*/
export const permission_edit_client_contact_hint = /** @type {((inputs?: Permission_Edit_Client_Contact_HintInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Permission_Edit_Client_Contact_HintInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_permission_edit_client_contact_hint(inputs)
	if (locale === "en-XA") return en_xa2_permission_edit_client_contact_hint(inputs)
