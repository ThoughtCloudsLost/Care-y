...
const en_xa2_intake_responses_unknown_field = /** @type {(inputs: Intake_Responses_Unknown_FieldInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Ùnknòwn fìèld ••••⟧`)
};
...
*/
export const intake_responses_unknown_field = /** @type {((inputs?: Intake_Responses_Unknown_FieldInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Intake_Responses_Unknown_FieldInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_intake_responses_unknown_field(inputs)
	if (locale === "en-XA") return en_xa2_intake_responses_unknown_field(inputs)
