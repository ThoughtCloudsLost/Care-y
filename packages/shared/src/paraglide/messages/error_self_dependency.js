...
/** @typedef {{ ticket: NonNullable<unknown> }} Error_Self_DependencyInputs */

const en_error_self_dependency = /** @type {(inputs: Error_Self_DependencyInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`A ${i?.ticket} cannot depend on itself.`)
};

const es_error_self_dependency = /** @type {(inputs: Error_Self_DependencyInputs) => LocalizedString} */ (i) => {
