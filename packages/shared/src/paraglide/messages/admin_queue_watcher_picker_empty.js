...
/** @typedef {{ volunteers: NonNullable<unknown> }} Admin_Queue_Watcher_Picker_EmptyInputs */

const en_admin_queue_watcher_picker_empty = /** @type {(inputs: Admin_Queue_Watcher_Picker_EmptyInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`No ${i?.volunteers} available to add`)
};

const es_admin_queue_watcher_picker_empty = /** @type {(inputs: Admin_Queue_Watcher_Picker_EmptyInputs) => LocalizedString} */ (i) => {
