...
const en_xa2_client_email_confirm_title = /** @type {(inputs: Client_Email_Confirm_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`⟦Cònfìrm èmàìl chàngè ••••••⟧`)
};
...
*/
export const client_email_confirm_title = /** @type {((inputs?: Client_Email_Confirm_TitleInputs, options?: { locale?: "en" | "es" | "en-XA" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Client_Email_Confirm_TitleInputs, { locale?: "en" | "es" | "en-XA" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "es") return es_client_email_confirm_title(inputs)
	if (locale === "en-XA") return en_xa2_client_email_confirm_title(inputs)
