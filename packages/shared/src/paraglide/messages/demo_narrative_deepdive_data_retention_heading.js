...
*/
export const demo_narrative_deepdive_data_retention_heading = /** @type {((inputs?: Demo_Narrative_Deepdive_Data_Retention_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Deepdive_Data_Retention_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
