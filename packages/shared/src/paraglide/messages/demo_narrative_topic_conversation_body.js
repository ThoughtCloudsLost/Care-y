...
const en_demo_narrative_topic_conversation_body = /** @type {(inputs: Demo_Narrative_Topic_Conversation_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`The main body of the ticket detail is a conversation thread showing messages between the volunteer and the client.
...
const es_demo_narrative_topic_conversation_body = /** @type {(inputs: Demo_Narrative_Topic_Conversation_BodyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`El cuerpo principal del detalle del ticket es un hilo de conversación que muestra mensajes entre el voluntario y el cliente.
