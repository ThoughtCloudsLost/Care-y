...
*/
export const ticket_delete_note_confirm_title = /** @type {((inputs?: Ticket_Delete_Note_Confirm_TitleInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Ticket_Delete_Note_Confirm_TitleInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_ticket_delete_note_confirm_title(inputs)
	return es_ticket_delete_note_confirm_title(inputs)
});