...
*/
export const demo_chip_resume_follow = /** @type {((inputs?: Demo_Chip_Resume_FollowInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Chip_Resume_FollowInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
