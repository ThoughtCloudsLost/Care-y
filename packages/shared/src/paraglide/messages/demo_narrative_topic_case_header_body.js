...
**Edicion.** El estado, la prioridad, el asignado y la cola se cambian desde el panel del caso, que se abre desde el alias del cliente o el boton de caso en la barra de navegacion. Los cambios se cifran en el navegador antes de enviarse al servidor.`)
};
