...
/** @typedef {{}} Admin_Queue_Editor_No_Org_KeyInputs */

const en_admin_queue_editor_no_org_key = /** @type {(inputs: Admin_Queue_Editor_No_Org_KeyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Organization key not loaded. Cannot create or edit queues.`)
};

const es_admin_queue_editor_no_org_key = /** @type {(inputs: Admin_Queue_Editor_No_Org_KeyInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Clave de la organizacion no cargada. No se pueden crear ni editar colas.`)
};
