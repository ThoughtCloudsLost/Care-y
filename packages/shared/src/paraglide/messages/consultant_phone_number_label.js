...
*/
export const consultant_phone_number_label = /** @type {((inputs?: Consultant_Phone_Number_LabelInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Consultant_Phone_Number_LabelInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_consultant_phone_number_label(inputs)
	return es_consultant_phone_number_label(inputs)
});