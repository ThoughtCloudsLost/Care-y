...
*/
export const admin_blocklist_placeholder = /** @type {((inputs?: Admin_Blocklist_PlaceholderInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Admin_Blocklist_PlaceholderInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_admin_blocklist_placeholder(inputs)
	return es_admin_blocklist_placeholder(inputs)
});