...
*/
export const demo_narrative_topic_compose_actions_heading = /** @type {((inputs?: Demo_Narrative_Topic_Compose_Actions_HeadingInputs, options?: { locale?: "en" | "es" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Demo_Narrative_Topic_Compose_Actions_HeadingInputs, { locale?: "en" | "es" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "en") return en_demo_narrative_topic_compose_actions_heading(inputs)
	return es_demo_narrative_topic_compose_actions_heading(inputs)
});