/**
 * Shim for packages/server/src/branding/branding-service.ts
 *
 * Replaces the sodium-native import (sodium_memzero) with
  ...
  return {
    ...
    async uploadIcons(
      ...
      try {
        ...
        // Replace sodium.sodium_memzero with libsodium-wrappers memzero
        _sodium.memzero(new Uint8Array(brandingKey));
      }
